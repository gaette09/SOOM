...
struct ProcessedWorkoutToRecoveryActivityMapper {
    func map(_ workout: ProcessedWorkout) -> RecoveryActivity {
        RecoveryActivity(
    ...
    private func estimateRelativeEffort(for workout: ProcessedWorkout) -> Int {
    ...
    private func estimateTrainingLoad(for workout: ProcessedWorkout) -> Double {
